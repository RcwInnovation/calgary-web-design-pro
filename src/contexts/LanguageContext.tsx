...
const translations = {
  es: {
    ...
    // Hero
    'hero.badge': 'Tecnología para empresas en Canadá',
    'hero.title.words1': 'Desarrollo,de',
    'hero.title.highlight': 'páginas web,',
    'hero.title.words2': 'software,a,medida,y,automatización,con,IA,en,Calgary',
    'hero.subtitle': 'RCW Innovation diseña e implementa sitios web, aplicaciones, sistemas de gestión y automatizaciones para empresas. La atención está disponible en español e inglés.',
    'hero.cta.consultation': 'Solicitar Asesoría',
    'hero.cta.diagnostic': 'Consultoría 5.0',
    'hero.card.innovation': 'Alcance definido',
    'hero.card.innovationDesc': 'Cada propuesta especifica funciones, integraciones, entregables y responsabilidades antes de iniciar.',
    'hero.card.strategy': 'Proceso documentado',
    'hero.card.strategyDesc': 'El trabajo se organiza en diagnóstico, diseño, desarrollo, implementación y seguimiento.',
    'hero.card.results': 'Medición acordada',
    'hero.card.resultsDesc': 'Las métricas se seleccionan según el proyecto y se revisan con el cliente durante la implementación.',
    ...
    'services.title': 'Servicios de desarrollo y automatización',
    'services.subtitle': 'RCW Innovation trabaja en ocho áreas. Cada servicio se define mediante un alcance, entregables, calendario y criterios de aceptación acordados con el cliente.',
    'services.viewMore': 'Consultar alcance',
    'service.1.title': 'Software a la Medida',
    'service.1.tag': 'Desarrollo',
    'service.1.description': 'Diseño y desarrollo de MVP, portales internos y plataformas web conectadas con los sistemas del cliente.',
    'service.1.features': 'Arquitectura modular,Integración mediante API,Paneles de administración',
    'service.2.title': 'Branding y Redes Sociales',
    'service.2.tag': 'Estrategia',
    'service.2.description': 'Definición de identidad visual, lineamientos de marca y planificación de contenido para canales digitales.',
    'service.2.features': 'Identidad visual,Calendario de contenidos,Campañas digitales',
    'service.3.title': 'Automatizaciones con IA',
    'service.3.tag': 'Operación',
    'service.3.description': 'Automatización de tareas de atención, ventas y operación mediante flujos conectados con CRM, ERP y otras aplicaciones.',
    'service.3.features': 'Flujos automatizados,Integración con CRM o ERP,Registro de interacciones',
    'service.4.title': 'Creación de Agentes IA',
    'service.4.tag': 'Inteligencia',
    'service.4.description': 'Configuración de asistentes conversacionales y agentes para consultar información autorizada y ejecutar tareas definidas.',
    'service.4.features': 'Asistentes conversacionales,Fuentes de datos autorizadas,Integración con sistemas',
    'service.5.title': 'Sistemas de Gestión',
    'service.5.tag': 'Operaciones',
    'service.5.description': 'Configuración y desarrollo de sistemas CRM, ERP y de gestión para centralizar procesos e información operativa.',
    'service.5.features': 'CRM o ERP,Paneles operativos,Flujos de aprobación',
    'service.6.title': 'Tarjeta Digital Profesional',
    'service.6.tag': 'Contacto',
    'service.6.description': 'Perfil digital para compartir información profesional mediante enlace, código QR, NFC y archivo vCard.',
    'service.6.features': 'Código QR o NFC,Archivo vCard,Estadísticas de visitas',
    'service.7.title': 'Diseño Web – App Móvil',
    'service.7.tag': 'Web y aplicaciones',
    'service.7.description': 'Diseño y desarrollo de sitios corporativos, tiendas en línea y aplicaciones web progresivas.',
    'service.7.features': 'Estructura técnica para SEO,Comercio electrónico,Aplicaciones PWA',
    'service.8.title': 'Mentoría & Capacitación',
    'service.8.tag': 'Formación',
    'service.8.description': 'Sesiones individuales y talleres para equipos sobre IA, automatización, productividad, experiencia de usuario y analítica.',
    'service.8.features': 'Plan de aprendizaje,Talleres prácticos,Material de seguimiento',
    ...
    'about.title': 'Tecnología',
    'about.titleHighlight': 'en español',
    'about.titleEnd': 'desde Calgary',
    'about.subtitle': 'RCW Innovation Inc. es una firma de consultoría tecnológica y de ingeniería con sede en Calgary, Alberta. Diseña soluciones para empresas de Canadá y Colombia y atiende en español e inglés.',
    'about.stat.1.number': 'Calgary',
    'about.stat.1.label': 'Sede en Alberta, Canadá',
    'about.stat.2.number': 'ES / EN',
    'about.stat.2.label': 'Atención bilingüe',
    'about.stat.3.number': 'CA / CO',
    'about.stat.3.label': 'Mercados atendidos',
    'about.stat.4.number': '2',
    'about.stat.4.label': 'Plataformas públicas',
    'about.platformsEvidence': 'Proyectos disponibles para consulta',
    'about.mission.title': 'Nuestra Misión',
    'about.mission.text': 'Diseñar e implementar soluciones digitales que respondan a una necesidad operativa definida. Cada proyecto combina análisis del proceso, desarrollo técnico, documentación y acompañamiento durante la implementación.',
    'about.vision.title': 'Nuestra Visión',
    'about.vision.text': 'Ampliar el acceso de empresas hispanohablantes en Canadá a servicios de desarrollo web, software y automatización con comunicación clara en español y soporte desde Calgary.',
    'about.values.title': 'Nuestros Valores',
    'about.value.1.title': 'Innovación continua',
    'about.value.1.description': 'Evaluamos cada herramienta según su utilidad, seguridad, costo y compatibilidad con el proyecto.',
    'about.value.2.title': 'Profesionalismo y calidad',
    'about.value.2.description': 'Definimos alcance, responsables, entregables y criterios de revisión antes de desarrollar.',
    ...
    'founder.subtitle': 'Perfil profesional, áreas de trabajo y plataformas públicas vinculadas a RCW Innovation.',
    ...
    'founder.bio2': 'Su trabajo combina ingeniería, dirección de proyectos y tecnología para diseñar sistemas de gestión, automatizaciones y productos digitales para organizaciones en Canadá y Colombia.',
    ...
    'founder.team.text': 'Como director ejecutivo y fundador, Ricardo coordina profesionales de ingeniería, desarrollo, estrategia y comunicación digital en estas áreas:',
    ...
    'founder.strategy.text': 'El trabajo comienza con la identificación de objetivos, tareas repetitivas, fuentes de información y restricciones. Con ese diagnóstico se define el alcance técnico y el plan de implementación.',
    'founder.engineering.title': 'Ingeniería, consultoría y transformación digital',
    'founder.engineering.text': 'RCW Innovation combina consultoría, diseño de procesos y desarrollo de software para conectar sitios web, sistemas internos, CRM, ERP y herramientas de automatización.',
    'founder.platforms.title': 'Plataformas propias e innovación',
    'founder.platforms.text': 'Estos proyectos públicos permiten consultar directamente parte del trabajo desarrollado por RCW Innovation.',
    'founder.platform1.name': 'Servicios Latinos Canada',
    'founder.platform1.desc': 'Marketplace público que reúne servicios, empleos y perfiles de negocios dirigidos a la comunidad hispanohablante en Canadá.',
  ...
  en: {
    ...
    'about.platformsEvidence': 'Public projects',
